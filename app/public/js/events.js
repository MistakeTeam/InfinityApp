                            ...
                            <div style="visibility: hidden;" id="util-player">
                                <div>
                                    <div class="player-T1ow86">
                                        ...
                                        <div class="player-playlist animation-default" style="display: none; width: 0px; z-index: -1;">
                                            <div class="playlist-contains">
                                                <div class="buttons-actions-playlist">
                                                    <div class="add-playlist">
                                                        <input type="file" id="pb-input" accept="video/* , audio/*" multiple="" style="display: none;">
                                                        <label class="animation-default" for="pb-input">
                                                            <svg class="ply-button" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Your_Icon" x="0px" y="0px" fill="#fff" width="30px" height="30px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                                                                <circle cx="18.132" cy="26.545" r="7.131"></circle>
                                                                <rect x="33.619" y="21.486" width="56.292" height="10.118"></rect>
                                                                <circle cx="18.132" cy="51.219" r="7.131"></circle>
                                                                <rect x="33.619" y="46.159" width="56.292" height="10.118"></rect>
                                                                <circle cx="18.132" cy="76.033" r="7.131"></circle>
                                                                <rect x="33.619" y="70.975" width="56.292" height="10.117"></rect>
                                                            </svg>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="player-controls-botton" style="opacity: 1;">
                                                ...
                                                <div class="controls-right">
                                                    ...
                                                    <span style="display: grid; position: relative;">
                                                        ...
                                                        <div class="ply-volume-panel animation-default" role="slider" aria-valuemin="0" aria-valuemax="100" tabindex="0" aria-valuenow="100" aria-valuetext="100% volume">
                                                            <div class="ply-volume-slider" style="touch-action: none;">
