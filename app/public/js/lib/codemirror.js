...
var CodeMirror = (function() {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var hasFocus;
        try { hasFocus = (document.activeElement == input); } catch (e) {}
        ...
        var instance = wrapper.CodeMirror = {
            ...
            setOption: function(option, value) {
                ...
                if (option == "mode" || option == "indentUnit") loadMode();
                    ...
                    onBlur();
                    input.blur();
                } else if (option == "readOnly" && !value) { resetInput(true); } else if (option == "theme") themeChanged();
        ...
        function readInput() {
            ...
            if (text.length > 1000) { input.value = prevInput = ""; } else prevInput = text;
            return true;
        }
        ...
        function operation(f) {
            return function() {
                ...
                try { var result = f.apply(this, arguments); } finally { if (!--nestedOperation) endOperation(); }
                return result;
            };
        }
    ...
    var hasSelection = window.getSelection ? function(te) {
        ...
        try { var range = te.ownerDocument.selection.createRange(); } catch (e) {}
